...
def record(event):
    ...
    try:
        ...
        #u = getQueueURL()
        u='https://sqs.us-east-1.amazonaws.com/621537911279/DiningChatbot'
        ...
        resp = SQS.send_message(
            ...
            MessageAttributes={
                ...
                "PeopleCount" : {
                    "StringValue": str(get_slots(event)["PeopleCount"]),
                    "DataType": "String"
                },
                "Date" : {
...
def validate_dining_suggestion(location, cuisine, time, date, numberOfPeople, phoneNumber):
    ...
    cuisines = ['chinese', 'indian', 'italian', 'mexican', 'thai', 'korean', 'american', 'french']
...
def diningSuggestions(intent_request,context):
    ...
    numberOfPeople = get_slots(intent_request)["PeopleCount"]
